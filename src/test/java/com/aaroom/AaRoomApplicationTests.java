...
/*    @Test
    ...
    public void testSuccess(){
        String token = "c83cef3e75a8485e9ce47505c88f4c59";
        HttpHeaders headers = new HttpHeaders();
        headers.add("Authorization", "token " + token);
        HttpEntity<String> entity = new HttpEntity<String>(headers);

        ResponseEntity<String> exchange = restTemplate.exchange("http://120.92.148.25:8099/rest/Geo/Cities", HttpMethod.POST, entity, String.class);
    ...
    public void test2(){
        ...
        requestBody.add("hotel_code","10257");
        //HttpEntity
        HttpEntity<MultiValueMap> requestEntity  = new HttpEntity<>(requestBody, headers);
        RestTemplate restTemplate = new RestTemplate();
        //
        ResponseEntity<String> exchange = restTemplate.exchange("http://120.92.148.25:8099/rest/static/hotel/:hotel_code", HttpMethod.POST, requestEntity, String.class);
        String body = exchange.getBody();
        System.out.println(body);
    ...
    @Test
    public void getAuth(){
        String plainCreds = "aahotel:aahotel849$";  //(client_id:client_secret)
        byte[] plainCredsBytes = plainCreds.getBytes();
        byte[] base64CredsBytes = Base64.encodeBase64(plainCredsBytes);
        String base64Creds = new String(base64CredsBytes);
        System.out.println(base64Creds);  //YWFob3RlbDphYWhvdGVsODQ5JA==
        ...
        //c83cef3e75a8485e9ce47505c88f4c59

    }
    @Test
    public void test5(){
        HttpHeaders headers = new HttpHeaders();
        headers.add("Authorization", "token " + "c83cef3e75a8485e9ce47505c88f4c59");
        headers.add("Content-Type","application/json");
        Map params = new HashMap<>();

        HttpEntity entity = new HttpEntity(params,headers);

        ResponseEntity<ShangmeiRetView> response = restTemplate.exchange("http://120.92.148.25:8099/rest/Geo/Provinces", HttpMethod.GET, entity, ShangmeiRetView.class);
